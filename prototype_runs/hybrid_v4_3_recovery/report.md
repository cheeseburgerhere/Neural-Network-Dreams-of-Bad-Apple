...
```powershell
New-Item "D:\Code_archive\Bad_apple\prototype_runs\hybrid_v4_3_recovery\STOP" -ItemType File
```
...
```json
{
  ...
  "run_dir": "D:\\Code_archive\\Bad_apple\\prototype_runs\\hybrid_v4_3_recovery",
  "epochs": 2,
  "history_length": 16,
  "rollout_steps": 16,
